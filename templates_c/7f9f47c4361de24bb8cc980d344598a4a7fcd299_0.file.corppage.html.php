...
>
    <?php echo '<script'; ?>
 src="js/corppage.js"><?php echo '</script'; ?>
>
    <!-- <?php echo '<script'; ?>
                        ...
                        <ul class='pagination'>
                            <?php if ($_smarty_tpl->tpl_vars['i']->value == $_smarty_tpl->tpl_vars['current_page']->value) {?>
                                <?php if ($_smarty_tpl->tpl_vars['i']->value > 1) {?>
                                    <li><a href='corppage.php?page=<?php echo ($_smarty_tpl->tpl_vars['i']->value-2)*20+1;?>
'><<</a></li>
                                <?php }?>
...
" href='corppage.php?page=<?php echo $_smarty_tpl->tpl_vars['j']->value;?>
...
?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['j']->value < $_smarty_tpl->tpl_vars['page_count']->value) {?>
                                    <li><a href='corppage.php?page=<?php echo $_smarty_tpl->tpl_vars['i']->value*20+1;?>
'>>></a></li>
                                <?php }?>
                            <?php }?>
                        </ul>
