            ...
            <table border="1" style="border-collapse:collapse">
                <tbody>
                    <tr>
                        ...
                        <td rowspan=""><span class="required">(*)</span><br>查估手稿<br>編號</td>
                        <td rowspan="">
                    ...
                    <tr>
                        ...
                        <td><span class="required">(*)</span><br>土地使用<br>權屬</td>
                        <td>
                    ...
                    <tr rowspan="2">
                        <td rowspan="2">
                            <div id="corp-owner">
                                <div id="corp-owner-1">
                                    ...
                                    <input type="text" style="width:80px;" name="corp-owner-1" autocomplete="off" placeholder="手動新增" required>
                                    <select id="corp-owner-select-1" name="corp-owner-select-1" style="width:80px;" onchange="autoFillInOwnerName('corp-owner',1)">
                                        <option value="" style="display:none">請選擇項目</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <td rowspan="2">
                            <div id="pId" class="input-align">
                                <div id="pId-1" style="margin-top:2px">
                        ...
                        <td colspan="2" rowspan="2">
                            <div id="telephone">
                                <div id="telephone-1" style="margin-top:-20px">
                        ...
                        <td colspan="2" rowspan="2">
                            <div id="cellphone">
                                <div id="cellphone-1" style="margin-top:-20px">
                        ...
                        <td>
                            <div id="land-owner">
                                <div id="land-owner-1">
                                    ...
                                    <select id="land-owner-select-1" name="land-owner-select-1" style="width:100px;" onchange="autoFillInOwnerName('land-owner',1)">
                                        <option value="" style="display:none">請選擇項目</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <tr>
                        ...
                        <td width='90px'>是否比照</td>
                        <td>備註</td>
                    </tr>

                    <tr>
                        <td>
                            <div id="corp-category">
                                <div id="corp-category-1" style="margin-top:5px">
                                    <select id="corp-category-option-1" name="corp-category-1" style="width:140px;" onchange="load_corp_item_Data(1)" onfocus="itemFocus(1)" onfocusout="itemOutFocus(1)" required>
                        ...
                        <td>
                            <div id="corp-item">
                                <!-- <div id="corp-item-1" style="margin-top:4px;margin-bottom:5px;height:22px"> -->
                                <div id="corp-item-1" style="margin-top:10px;margin-bottom:5px;height:22px">
                                    <input id="corp-item-option-1" name="corp-item-1" list="corp-item-list-1" autocomplete="off" style="width:140px;margin:0" placeholder="點擊選擇或搜尋" onchange="load_corp_type_Data(1)" onfocus="itemFocus(1)" onfocusout="itemOutFocus(1)" required>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div id="corp-type">
                                <div id="corp-type-1" style="margin-top:5px;">
                                    <select id="corp-type-option-1" name="corp-type-1" style="width:140px;" onchange="load_corp_unit_Data(1)" onfocus="itemFocus(1)" onfocusout="itemOutFocus(1)" required>
                        ...
                        <td>
                            <div id="corp-num">
                                <!-- <div id="corp-num-1" style="margin-top:4px;margin-bottom:5px;height:22px"> -->
                                <div id="corp-num-1" style="margin-top:10px;margin-bottom:5px;height:22px">
                                    <input type="text" name="corp-num-1" title="只能輸入10位以下數字(含小數點)" style="margin:0" placeholder="請輸入數量" onchange="autoCalculateArea(1)" onfocus="itemFocus(1)" onfocusout="itemOutFocus(1)" required>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div id="corp-unit">
                                <div id="corp-unit-1" style="margin-top:5px;">
                                    <select class="" name="corp-unit-1" onfocus="itemFocus(1)" onfocusout="itemOutFocus(1)" required>
                        ...
                        <td colspan="2">
                            <div id="corp-area">
                                <!-- <div id="corp-area-1" style="margin-top:4px;margin-bottom:5px;height:22px"> -->
                                <div id="corp-area-1" style="margin-top:10px;margin-bottom:5px;height:22px">
                                    <input type="text" name="corp-area-1" class="large-input-size" placeholder="點擊後自動計算面積" style="margin:0" onfocus="itemFocus(1)" onfocusout="itemOutFocus(1)" required>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div id="corp-equal">
                                <div id="corp-equal-1" style="margin-top:5px;margin-bottom:0px;height:22px">
                                    <input type="checkbox" value="" id="corp-equal-check-1" name="corp-equal-1" onchange="corpEqual(1)" onfocus="itemFocus(1)" onfocusout="itemOutFocus(1)">比照項目
                                </div>
                            </div>
                        </td>
                        ...
                        <td colspan="">
                            <div id="corp-note">
                                <!-- <div id="corp-note-1" style="margin-top:4px;margin-bottom:5px;height:22px"> -->
                                <div id="corp-note-1" style="margin-top:10px;margin-bottom:5px;height:22px">
                                    <input type="text" name="corp-note-1" class="large-input-size" placeholder="輸入比照物 ex.樹葡萄" style="margin:0" onfocus="itemFocus(1)" onfocusout="itemOutFocus(1)">
                                </div>
                            </div>
                        </td>
                    </tr>
